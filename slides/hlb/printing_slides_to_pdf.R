...
# Usage: set chrome location, main file at bottom then run this script
...
Sys.setenv(CHROMOTE_CHROME="C:/Users/ncsizemore/AppData/Local/Google/Chrome/Application/chrome.exe")


xaringan_to_pdf("C://Users/ncsizemore/Documents/ncsizemore.github.io_hugo.files/static/slides/hlb/hlb.html", delay = 1)
